...
export default function Home() {
  ...
  return (
    <div className="flex-1 animate-fadeIn bg-transparent">
      {/* Hero Section */}
      <Hero />

      {/* NGO Welcome & Core Mission */}
      <section className="py-24 relative overflow-hidden bg-brand-gold-50/20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="pt-4 flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
                <Link
                  to="/about"
                  className="inline-flex items-center justify-center space-x-2 bg-slate-900 hover:bg-slate-800 text-white font-medium px-6 py-3.5 rounded-full hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300"
                >
                ...
                <Link
                  to="/donate"
                  className="inline-flex items-center justify-center space-x-2 bg-gradient-to-r from-brand-gold-500 to-amber-600 hover:shadow-lg hover:shadow-brand-gold-500/20 hover:-translate-y-0.5 active:translate-y-0 text-white font-semibold px-6 py-3.5 rounded-full shadow-md transition-all duration-300"
                >
            ...
            <div className="lg:col-span-5 relative">
              ...
              <div className="absolute -inset-4 bg-brand-gold-500/10 rounded-3xl blur-2xl -z-10 animate-pulse-soft"></div>
      ...
      <section className="bg-slate-900 text-white py-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-2 lg:grid-cols-4 gap-8 text-center relative z-10">
          <div className="space-y-1">
            <span className="text-3xl md:text-5xl font-serif font-bold text-brand-gold-400">350+</span>
            <p className="text-xs uppercase tracking-wider text-slate-400 mt-1">Sheltered Cows</p>
          </div>
          <div className="space-y-1">
            <span className="text-3xl md:text-5xl font-serif font-bold text-brand-gold-400">12+</span>
            <p className="text-xs uppercase tracking-wider text-slate-400 mt-1">Acres Pasture</p>
          </div>
          <div className="space-y-1">
            <span className="text-3xl md:text-5xl font-serif font-bold text-brand-gold-400">15,000+</span>
            <p className="text-xs uppercase tracking-wider text-slate-400 mt-1">Daily Meals</p>
          </div>
          <div className="space-y-1">
            <span className="text-3xl md:text-5xl font-serif font-bold text-brand-gold-400">24/7</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {galleryItems.map((item, idx) => (
              <div
                key={idx}
                className="bg-white border border-brand-gold-100/60 rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl hover:border-brand-gold-200 hover:-translate-y-1.5 transition-all duration-350 flex flex-col group cursor-default"
              >
                ...
                <div className="p-6 space-y-2 flex-1 flex flex-col justify-between">
                  <div>
                    <h3 className="text-lg font-serif font-bold text-slate-800 group-hover:text-brand-gold-700 transition-colors duration-300">{item.title}</h3>
      ...
      <section className="py-20 bg-brand-gold-50/10 border-t border-brand-gold-100/50">
        <div className="max-w-4xl mx-auto px-4 text-center space-y-6">
          ...
          <div className="pt-2">
            <Link
              to="/seva"
              className="inline-flex items-center space-x-2 bg-brand-gold-500 hover:bg-brand-gold-600 text-white font-bold px-8 py-4 rounded-full shadow-lg hover:scale-105 transition-transform"
            >
