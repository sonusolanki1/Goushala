...
export default function About() {
  const highlights = [
    ...
    {
      icon: <Heart className="w-6 h-6 text-brand-gold-600" />,
    ...
    {
      icon: <Smile className="w-6 h-6 text-brand-gold-600" />,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-slate-600 mt-6 text-base md:text-lg font-light leading-relaxed">
            Krishna Govind Seva Sansthan Trust operates with a singular focus: to serve the sacred cows. 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-20">
          ...
          <div className="lg:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-6">
            {highlights.map((item, idx) => (
              <div 
                key={idx} 
                className="bg-white p-6 rounded-2xl shadow-sm border border-amber-100 hover:shadow-md hover:border-amber-200 transition-all duration-300 group"
              >
                <div className="bg-amber-50 p-3 rounded-xl w-fit group-hover:bg-brand-gold-500 group-hover:text-white transition-colors duration-300">
                  {item.icon}
                </div>
                <h4 className="text-lg font-bold text-slate-800 mt-4 font-serif">
                  {item.title}
                </h4>
